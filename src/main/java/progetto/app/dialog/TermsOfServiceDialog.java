...
/**
 * Dialog che mostra il testo completo dei Termini di Servizio
 * dell'applicazione.
 * <p>
 * Estende {@link Dialog} di JavaFX e costruisce il layout al volo:
 * un {@link ScrollPane} con le sezioni dei ToS impaginate tramite il metodo
 * helper privato {@link #addSection(VBox, String, String)}. Il dialog è
 * ridimensionato e chiudibile tramite il pulsante
 * {@code CLOSE}.
 * </p>
 */
public class TermsOfServiceDialog extends Dialog<ButtonType> {
        ...
        /**
         * Costruisce e configura il dialog con il testo completo dei Termini di
         * Servizio.
         * <p>
         * Aggiunge tutte le sezioni al {@link ScrollPane} interno
         * e applica lo stile grafico AtlantaFX al pannello.
         * </p>
         */
        ...
        /**
         * Aggiunge una sezione titolata al contenitore verticale del dialog.
         * <p>
         * Il titolo viene reso in grassetto e il testo del contenuto
         * viene avvolto automaticamente alla larghezza del contenitore.
         * </p>
         *
         * @param container il {@link VBox} a cui aggiungere la sezione
         * @param title     il titolo della sezione
         * @param content   il testo del paragrafo
         */
        ...
        /**
         * Mostra il dialog in modalità bloccante e attende la chiusura da parte
         * dell'utente.
         */
